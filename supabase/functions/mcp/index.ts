...
var search_documents_default = defineTool2({
  ...
  description: "Full-text search the approved document text for a word or phrase, including the kerneopgaver in section 2.2/2.3, their titles, and the specialties each kerneopgave collaborates with. Returns matching document ids, titles and match counts.",
